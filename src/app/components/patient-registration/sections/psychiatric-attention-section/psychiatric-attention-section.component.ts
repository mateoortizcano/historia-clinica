...
@Component({
  selector: 'app-psychiatric-attention-section',
  imports: [ReactiveFormsModule],
  templateUrl: './psychiatric-attention-section.component.html',
  styleUrl: './psychiatric-attention-section.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PsychiatricAttentionSectionComponent {
  private fb = new FormBuilder();
  
  sectionTitle = input<string>('Atención Psiquiátrica Anterior');
